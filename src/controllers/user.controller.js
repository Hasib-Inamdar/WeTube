  ...
  const user = await User.aggregate([
    ...
    },
    {
      $lookup: {
        ...
        pipeline: [
          {
            $lookup: {
              ...
              ], // This pipeline is for th having the selected fileds in the user object
            },
          },
          {
            $addFields: {
        ...
        // The above pipeline is used to join the respetive video with there owner
        // Basically, each watched video will be linked with there owner
      },
    },
  ]);
